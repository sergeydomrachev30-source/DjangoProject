...
class AuthorForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['birthdate'].widget.attrs.update({'class': 'form-control', 'placeholder': 'Введите дату рождения'})
    ...
    def clean(self):
        ...
        if Author.objects.filter(first_name=first_name, last_name=last_name).exists():
            raise forms.ValidationError('Автор с таким именем и фамилией существует')
        return cleaned_data
